...
// ── Standalone extension export (themeMap.ts is a utility module) ───────────
// Default export satisfies pi's "must export factory function" requirement.
// This module provides theme mapping utilities; actual theme application
// happens when imported and called by other extensions (e.g., theme-cycler.ts).

export default function (pi: ExtensionAPI) {
	// Noop — utility module. Theme logic triggered via applyExtensionDefaults().
}
